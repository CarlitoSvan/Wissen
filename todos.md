## Git Befehle
```
git status    prüft ob lokale Repository mit der remote Repository übereinstimmt und zeigt Änderungen auf sowie aktuellen branch
git pull      remote Repository wird mit lokaler synchronisiert
